					...
					<div class="p-r-50 p-r-0-lg">
						<div class="p-b-40">
							...
							<div class="blog-detail-txt p-t-33">
								...
								<p class="p-b-25">
								Laptop Acer seri PREDATOR ini  meskipun memiliki desain fisik yang futuristik dan  garang dengan sasis hitam dan aksen merah pada keseluruhan casing mereka, keduanya bukan lah tergolong laptop yang tipis dan ringan. Tapi bukanlah masalah bagi para gamers yang tergolong sebagai segmen pengguna yang lebih memperhatikan fungsi dari pada estetika desain.  Ditambah lagi spesifikasi yang di agung – agungkan oleh pecinta game kebanyakan. Spesifikasi yang dapat memanjakan para pecinta game lewat beberapa segi dan juga fitur – fitur unik yang tidak dimiliki laptop gaming lainya.
								</p>

								<p class="p-b-25">
								Kedua laptop ini bersenjatakan  layar berukuran 15,6 inci yang menggunakan panel IPS (In-Plane Switching) dengan resolusi full HD 1920 x 1080 piksel yang mampu menghasilkan sudut pandang yang luas. Keduanya turut dilengkapi port USB-C. Pabrikan asal Taiwan yang terkenal dengan jajaran smartphone Liquid series ini membekali laptop gaming andalannya dengan sistem operasi Windows 10 besutan Microsoft yang terinstal di dalamnya.
								</p>
							</div>
