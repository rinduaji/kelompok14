					...
					<div class="p-r-50 p-r-0-lg">
						...
						<div class="item-blog p-b-80">
							<a href="<?php echo base_url('index.php/BlogDetail/index');?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo base_url('assets/images/Predator1.jpg');?>" alt="IMG-BLOG">
							...
							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="<?php echo base_url('index.php/BlogDetail/index');?>" class="m-text24">
										Acer Predator 15
									</a>
								</h4>
						...
						<div class="item-blog p-b-80">
							<a href="<?php echo base_url('index.php/BlogDetail/index');?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo base_url('assets/images/sharp1.jpg');?>" alt="IMG-BLOG">
						...
						<div class="item-blog p-b-80">
							<a href="<?php echo base_url('index.php/BlogDetail/index');?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo base_url('assets/images/samsung1.jpg');?>" alt="IMG-BLOG">
