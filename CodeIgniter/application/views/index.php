										...
										<div class="facts">
											<div class="register">
												<form action="#" method="post">			
													...
													<br><br>			
													<input name="No Telepon" placeholder="No Telepon" type="text" required="">	
													<br><br>					
													<input name="Kode Pos" placeholder="Kode Pos" type="text" required="">
													<br><br>	
													...
													<input placeholder="Confirm Password" name="Password" type="password" required=""> <br><br>
